...
SCHEMA_PATH = Path('/home/chetan/projects/hops-review/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/chetan/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    restaurant: 'actions.RestaurantActions[models.Restaurant]'
    ...
    def __init__(
        ...
        *,
        ...
        self.restaurant = actions.RestaurantActions[models.Restaurant](self, models.Restaurant)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/home/chetan/projects/hops-review/backend/prisma/schema.prisma',
        }
...
class Batch:
    restaurant: 'RestaurantBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.restaurant = RestaurantBatchActions(self)
